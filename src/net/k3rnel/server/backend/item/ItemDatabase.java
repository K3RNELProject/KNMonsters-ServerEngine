package net.k3rnel.server.backend.item;
...
//							System.out.println(m_descList.item(0).getChildNodes().item(0).getNodeValue());
							...
							for (int l = 0; l < m_attributesList.getLength(); l++) {
								...
								if(m_attributesList.item(l).getChildNodes().item(0).getNodeValue().equals("MONSTER"))
									item.addAttribute(ItemAttribute.MONSTER);
