...
import net.k3rnel.server.battle.mechanics.moves.MoveSet;
...
public class MonsterSpecies {
	...
	private static MonsterSpeciesData m_default = new MonsterSpeciesData();
    @Element
	...
	@ElementArray
    transient protected MonsterType[] m_type;
    @Element
	...
	@ElementArray
	protected MonsterEvolution [] m_evolutions;
	@ElementArray
	...
	/**
	 * Returns a random item dropped by the Monster, -1 if no item was dropped
	 * @return
	 */
     ...
     */
    public static MonsterSpeciesData getDefaultData() {
        return m_default;
    }
     ...
     */
    public static void setDefaultData(MonsterSpeciesData data) {
        m_default = data;
    }
     ...
     * This formula places the monster's level within the interval [60, 100]
     * based on base stats.
     */
    ...
    /**
     * Return whether a monster can have a particular ability.
     */
    public boolean canUseAbility(MonsterSpeciesData data, String ability) {
     ...
     */
    public String[] getPossibleAbilities(MonsterSpeciesData data) {
        return data.getPossibleAbilities(m_name);
    }
    
    /**
     * Construct a new monster species with arbitrary stats.
     */
    public MonsterSpecies(int species, String name, int[] base, int gender) {
        m_species = species;
        m_name = name;
        m_base = base;
        m_genders = gender;
    ...
    /**
     * Read a MonsterSpecies from a stream, backed by an arbitrary
     * MonsterSpeciesData object.
     */
    public synchronized static Object readObject(MonsterSpeciesData data, ObjectInputStream in)
            throws IOException, ClassNotFoundException {
        MonsterSpeciesData old = m_default;
        m_default = data;
    ...
    /**
     * This methods prevents monster with arbitrary base stats from being
     * loaded. Monsters are unserialised only by id and their stats are loaded
     * from that id.
     *
     * This method creatively throws an IOException if the species id does not
     * correspond to a valid monster species.
     *
    ...
    /**
     * Creates a new instance of MonsterSpecies
     */
    public MonsterSpecies(MonsterSpeciesData data, int i) throws MonsterException {
        this(data.getSpecies(i));
    }
    
    /**
     * Allows for construction from another MonsterSpecies.
     */
    public MonsterSpecies(MonsterSpecies i) {
     ...
     */
    public boolean canLearn(MonsterSpeciesData data, String move) {
	...
	public void setType(MonsterType[] mType) {
		m_type = mType;
	}
	...
	public String getMonsterDexInfo() {
		return m_monsterdex;
	}
	public void setMonsterDexInfo(String mMonsterDex) {
		m_monsterdex = mMonsterDex;
	}
	...
	public MonsterEvolution [] getEvolutions() {
		return m_evolutions;
	}
	public void setEvolutions(MonsterEvolution [] mEvolutions) {
