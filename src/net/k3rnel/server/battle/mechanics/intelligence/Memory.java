package net.k3rnel.server.battle.mechanics.intelligence;
...
public class Memory implements Serializable {
    ...
    protected MonsterType m_me, m_opponent;
     ...
     */
    public Memory(MonsterType me, MonsterType opponent, boolean low, String move) {
        m_me = me;
        m_opponent = opponent;
        m_low = low;
        m_move = move;
