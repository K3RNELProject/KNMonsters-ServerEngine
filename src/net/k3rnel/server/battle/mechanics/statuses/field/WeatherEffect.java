...
public abstract class WeatherEffect extends FieldEffect {
     ...
     *  Note: The same effect is applied to all monster on the field! You cannot
     *        do this naively with just a single array!
     */
    private MonsterType[][] m_types = new MonsterType[2][];
    ...
    protected boolean hasEffects(BattleField field) {
        Monster[] monster = field.getActiveMonster();
     ...
     */
    protected void setTypes(Monster p, MonsterType[] types, boolean apply) {
