...
public class ChoiceBandItem extends HoldItem {
    ...
    protected void transformChoice(Monster p, BattleMechanics mech, MoveListEntry entry) {
    }
    
    public void setChoice(Monster p, BattleMechanics mech, MoveListEntry entry) {
        m_move = entry;
