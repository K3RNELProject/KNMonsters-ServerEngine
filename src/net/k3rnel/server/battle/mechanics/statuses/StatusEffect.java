...
public abstract class StatusEffect implements Cloneable {
    ...
    private Monster m_inducer;
    
    /**
     * Set the pokemon who induced this effect.
     */
    public void setInducer(Monster p) {
        m_inducer = p;
    }
     ...
     */
    public final boolean apply(Monster source, Monster p) {
    ...
    public final double getEffectiveness(
            MonsterType move, MonsterType pokemon, boolean enemy) {
        if (enemy) {
    ...
    protected double getTransformedEffectiveness(MonsterType move, MonsterType pokemon) {
        return move.getMultiplier(pokemon);
    }
    
    protected double getEnemyTransformedEffectiveness(MonsterType move, MonsterType pokemon) {
        return move.getMultiplier(pokemon);
    }
    ...
    public final MoveListEntry getMove(
            Monster p, MoveListEntry move, boolean enemy) {
        if (enemy) {
    ...
    protected MoveListEntry getEnemyTransformedMove(Monster p, MoveListEntry move) {
        return move;
    }
    
    protected MoveListEntry getTransformedMove(Monster p, MoveListEntry move) {
        return move;
    }
