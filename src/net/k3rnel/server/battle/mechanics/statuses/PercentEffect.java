...
import net.k3rnel.server.battle.mechanics.moves.MoveList.HealBlockEffect;
...
public class PercentEffect extends StatusEffect {
    ...
    protected int calculateChange(Monster poke, double percent) {
        double maximum = (double)poke.getStat(Monster.S_HP);
