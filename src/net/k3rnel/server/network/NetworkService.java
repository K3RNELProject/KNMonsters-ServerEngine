...
import net.k3rnel.server.feature.ChatManager;
import net.k3rnel.server.network.codec.K3RNELCodecFactory;
...
public class NetworkService {
	...
	public void start() {
		...
		if(m.connect(GameServer.getDatabaseHost(), 
			...
			m.query("UPDATE kn_members SET lastLoginServer='null' WHERE lastLoginServer='"
		...
		m_tcpAcceptor.getFilterChain().addLast("codec", new ProtocolCodecFilter(new K3RNELCodecFactory()));
		...
		chain.addLast("codec", new ProtocolCodecFilter(new K3RNELCodecFactory()));
